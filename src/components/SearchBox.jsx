...
export default function SearchBox() {
  ...
  return (
    <form 
    className="flex items-center border border-gray-200 rounded-full shadow-lg 
    ...
    >
            ...
            <BsFillMicFill className="hidden sm:inline-flex text-4xl text-blue-500 pl-4 border-l-2
